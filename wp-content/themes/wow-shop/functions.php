...
function wow_shop_scripts() {
	...
	wp_enqueue_style( 'wow-shop-default', get_template_directory_uri(). '/assets/css/default.css', array(), '1.0', 'all' );
	wp_enqueue_style( 'wow-shop-style', get_stylesheet_uri() );

    wp_enqueue_script( 'popper', get_template_directory_uri() . '/assets/js/popper-v1.12.9.min.js', array('jquery'), '4.0.0', true );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), '1.12.9', true );
...
add_action( 'wp_enqueue_scripts', 'wow_shop_scripts' );
